...
/**
 * Generates monthly rental payments for a three-year contract.
 */
public class ThreeYearContractRentalGenerator implements RentalCalculator {

    private static final int NUMBER_OF_RENTALS = 36;
    private static final double INTEREST_RATE = 0.03;

    /**
     * Generates thirty-six monthly rental payments for the given contract.
     *
